...
{
    public class PersistentMultipleObjectPool : PersistentSingleton<MultipleObjectPool> 
    {
            ...
            Quaternion rotation = default, Transform parent = default)
        {
            ...
            if (_currentObjectPool is null)
            {
                ...
                if (_currentPoolPrefab is null) return null;
        ...
        PoolPrefab CreatePoolObject()
        {
            ...
            //## Create
            List<PoolPrefab> activePoolObjectList = new List<PoolPrefab>();
